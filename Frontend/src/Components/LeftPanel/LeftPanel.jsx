          ...
          <ul className="space-y-2 font-medium">
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `flex items-center p-2 rounded-lg  ${
                    isActive ? "bg-[#9afcd9] text-grapy-500" : "text-gray-900 hover:bg-gray-100 group"
                  }`
                }
              >
                <svg
            ...
            <li>
              ...
              >
                ...
                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium bg-gray-300 rounded-full">
                  Live
                </span>
              </NavLink>
            </li>
